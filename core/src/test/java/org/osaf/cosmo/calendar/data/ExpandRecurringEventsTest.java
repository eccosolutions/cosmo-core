...
public class ExpandRecurringEventsTest extends TestCase {
    ...
    public void testExpandEvent() throws Exception {
        ...
        Assert.assertEquals("event 6", event.getProperties().<Summary>getProperty(Property.SUMMARY).getValue());
    ...
    public void testExpandEventWithOverrides() throws Exception {
        ...
        event = it.next();
        Assert.assertEquals("event 6 changed", event.getProperties().<Summary>getProperty(Property.SUMMARY).getValue());
